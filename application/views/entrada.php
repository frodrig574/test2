...
<div class="row">
	<div class="col-sm-8 col-sm-offset-2 col-xs-12 col-md-6 col-md-offset-3">
		<div class="content-form-rol">
			<header><p>documentos de entrada</p><i class="icons fa fa-plus-circle adddocuments" ></i></header>
			<div class="addDocuments" id="addDocuments">
				<?=form_open(base_url()."Userlog/addDocuments")?>
					<div class="row">
